export default function Contact() {
  return (
    <section id="contact" className="flex justify-center px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col items-center max-w-4xl w-full px-6 md:px-10 py-5">
        ...
        <div className="flex flex-col items-center space-y-4">
          <a
            href="mailto:nvietthanh02@gmail.com"
            className="flex items-center text-dark-blue hover:text-light-blue transition font-medium"
          >
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            nvietthanh02@gmail.com
          </a>
